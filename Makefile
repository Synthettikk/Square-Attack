...
build/gen_sets.o: src/gen_sets.c
	gcc -I include -c src/gen_sets.c -o build/gen_sets.o
...
build/main_4r: build/main_4r.o build/GF8_Arithmetics.o build/helpers.o build/aes.o build/load_sets.o build/gen_sets.o
	gcc build/main_4r.o build/GF8_Arithmetics.o build/helpers.o build/aes.o build/load_sets.o build/gen_sets.o -o build/main_4r

test/tests: test/tests.o build/GF8_Arithmetics.o build/helpers.o build/aes.o build/load_sets.o
	gcc test/tests.o build/GF8_Arithmetics.o build/helpers.o build/aes.o build/load_sets.o build/gen_sets.o -o test/tests
